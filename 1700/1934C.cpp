...
{  
    ...
    int tr_col = min(m,dist+1);
    int tr_row = dist+2-tr_col;

    int bl_row = min(n,dist+1);
    int bl_col = dist+2-bl_row;

    cout << "? " << tr_row << " " << tr_col << endl;
    int p1; cin>>p1; 
    if(p1==0)
    {
        cout << "! " << tr_row << " " << tr_col << endl; return;
    }
    p1 /= 2;

    cout << "? " << bl_row << " " << bl_col << endl;
    int p2; cin>>p2; 
    if(p2==0)
    {
        cout << "! " << bl_row << " " << bl_col << endl; return;
    }
    p2 /=2;

    cout << "? " << tr_row+p1 << " " << tr_col-p1 << endl;
    int p3; cin>>p3;
    if(p3==0)
    {
        cout << "! " << tr_row+p1 << " " << tr_col-p1 << endl; return;
    }

    cout << "! " << bl_row-p2 << " " << bl_col+p2 << endl; return;
}
