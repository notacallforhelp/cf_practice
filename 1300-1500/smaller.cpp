...
void solve()
{
    ...
    set<char> s; s.insert('a');
    set<char> t; t.insert('a');
    map<char,int> s_m; s_m['a']++;
    map<char,int> t_m; t_m['a']++;
    ...
    while(q--)
    {
        ...
        char smallest_s = *s.begin();
        char largest_s = *s.rbegin();

        char largest_t = *t.rbegin();

        if(largest_t>smallest_s)
        {
            cout << "YES" << endl;
        }
        else if(smallest_s==largest_s&&smallest_s==largest_t&&s_m[smallest_s]<t_m[largest_t])
        {
            cout << "YES" << endl;
        }
        else
